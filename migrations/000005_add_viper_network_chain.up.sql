...
VALUES 
    ((SELECT id FROM chain_static WHERE chain_id = 0001), 'http://localhost:8082', 'local-node', true, 10),
    ((SELECT id FROM chain_static WHERE chain_id = 0001), 'http://localhost:26657', 'tendermint-rpc', true, 5);
